...
namespace WebApp.Controllers
{
    ...
    public class DashboardEadController : BaseController
    {
        ...
        public async Task<IActionResult> Index(IFormCollection collection)
        {
            ...
            var fomentos = new SelectList(ApiClientFactory.Instance.GetFomentoAll(), "IdIdMunicipio", "Nome", DashboardEad.FomentoId);
            var deficiencias = new SelectList(ApiClientFactory.Instance.GetDeficienciaAll().Where(x => x.Status), "Id", "Nome", DashboardEad.DeficienciaId);
            ...
            var etnias = new SelectList(list, "IdNome", "Nome", DashboardEad.Etnia);
            ...
            model.DashboardEad.StatusLaudos = new StatusLaudosDto();
